...
(function(){ 'use strict';
  ...
  var app = angular.module('dtr4', [
    ...
    'profileMsgsController', 'authuserService',
  ]);
  ...
  app.run([ '$rootScope', '$window', '$location', '$http', 'Authuser', 'Countries', 'Talk',
   function( $rootScope,   $window,   $location,   $http,   Authuser,   Countries,   Talk ){
    ...
    $rootScope.countriesPromise = Countries
    .then( function( data ){ $rootScope.countries = data });
